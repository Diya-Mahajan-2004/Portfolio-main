...
function ResumeCaseStudy() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#00B1D2FF] to-[#FDDB27FF] p-8 rounded-lg shadow-lg max-w-screen-lg mx-auto animate-fade-in text-gray-200">
      <h1 className="text-4xl font-bold mb-8 text-center">Interactive Resume Case Study</h1>

      {/* Main content of your case study */}
      <div className="mb-8 border-[6px] border-[#613c0c] bg-gradient-to-r from-[#0063B2FF] to-[#64b3d7] rounded-lg overflow-hidden">
        {/* Video of Resume */}
        <video
          ref={videoRef}
          src={ResumeVideo}
      ...
      <div className="bg-gradient-to-r from-[#295a62] to-[#826f10]  p-6 rounded-lg shadow-md mb-8 transform hover:scale-105 transition-transform duration-300">
      ...
      <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-3">
        <div className="border-[6px] border-[#613c0c] rounded-lg overflow-hidden">
          <img
            src={Resume1}
      ...
      <div className="bg-gradient-to-r from-[#826f10] to-[#295a62] p-6 rounded-lg shadow-md mb-8 transform hover:scale-105 transition-transform duration-300">
