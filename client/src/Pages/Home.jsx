  ...
  const renderContent = () => {
    switch (selectedItem) {
      ...
      case 'about':
        return <div className="content"><a href=""></a></div>;
      default:
        return <div className="content">Hii</div>;
    }
  };
  ...
  return (
    <div className="container" style={{ backgroundColor: containerColor }}>
      <div className="sidebar">
        <ul className="menu">
          <li
            onClick={() => handleItemClick('projects', '#686868')}
          ...
          <li
            onClick={() => handleItemClick('about', '#7CB9E8')}
        ...
        <div className="social-icons">
          <a href="https://www.linkedin.com" className="icon-wrapper" style={{ color: containerColor }}>
            <FaLinkedin className="icon bg-white text-[2rem] rounded-full p-1" />
          </a>
          <a href="https://www.github.com" className="icon-wrapper" style={{ color: containerColor }}>
            <FaGithub className="icon bg-white text-[2rem] rounded-full p-1" />
          </a>
          <a href="https://example.com/resume.pdf" className="icon-wrapper " style={{ color: containerColor }}>
            <FaFileAlt className="icon bg-white text-[2rem] rounded-full p-1" />
          </a>
          <a href="https://www.twitter.com" className="icon-wrapper " style={{ color: containerColor }}>
